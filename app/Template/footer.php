      ...
      <ul class="nospace linklist">
        <li>
          <article>
            ...
            <p class="nospace">Quis quam in hendrerit elit donec hendrerit sollicitudin imperdiet curabitur […]</p>
          </article>
        </li>
        <li>
          <article>
            ...
            <p class="nospace">Ultricies aliquam nisi vitae pulvinar donec luctus ex ex eget ornare tortor […]</p>
          </article>
        </li>
      </ul>
    </div>
